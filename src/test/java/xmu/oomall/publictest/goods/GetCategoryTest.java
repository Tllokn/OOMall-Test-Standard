...
public class GetCategoryTest {
    @Value("http://${oomall.host}:${oomall.port}/goodsInfoService/categories?page=2&limit=1")
    String url;
    @Value("http://${oomall.host}:${oomall.port}/goodsInfoService/categories?page=2&limit=-1")
    String url2;
    @Value("http://${oomall.host}:${oomall.port}/goodsInfoService/categories?page=-1&limit=2")
    String url3;
    ...
    public void getCategory_001() throws Exception {
        ...
        /*assert判断*/
        PageInfo category_1 = JacksonUtil.parseObject(body, "data", PageInfo.class);
        assertEquals(2, category_1.getPageSize());
        assertEquals(1, category_1.getPageNum());
    }
