...
public class OrdersTest {
    ...
    public void tc_Orders_003() throws Exception{
        ...
        cartItem.setGmtModified(LocalDateTime.now());
        cartItem.setNumber(5);
        cartItem.setProductId(140); //3kg price 0.01
        ...
        cartItem.setGmtModified(LocalDateTime.now());
        cartItem.setNumber(5);
        cartItem.setProductId(221); //0kg price 0.01
        ...
        /**************************************************/
        Address address = new Address();
        address.setCity("焦作市");//190
        address.setProvince("河南省");
        address.setCounty("解放区");
        address.setAddressDetail("科研楼106");
        orderSubmitVo.setAddress(address);
        ...
        assertEquals(0.1, retOrder.getGoodsPrice());
        assertEquals(15, retOrder.getFreightPrice());
    }
}
